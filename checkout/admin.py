...
class BeerLineItemAdminInline(admin.TabularInline):
    ...
    Attributes:
        ...
        readonly_fields: Specifies which fields should be read-only in the admin interface (lineitem_total).
    """
    model = BeerLineItem
...
class OrderAdmin(admin.ModelAdmin):
    ...
    This class defines how the Order model is presented in the Django admin interface,
    including inlines, readonly fields, displayed fields, list display, and ordering.

    Attributes:
        model: Specifies the model to be represented (Order).
        inlines: Specifies the inline models to be displayed with the Order model (BeerLineItemAdminInline, MerchLineItemAdminInline).
        readonly_fields: Specifies which fields should be read-only in the admin interface.
        fields: Specifies the fields to be displayed and their order in the edit view of the admin interface.
        list_display: Specifies which fields to display in the list view of the admin interface.
        ordering: Specifies the default ordering of records in the admin interface list view.
    """
    model = Order
